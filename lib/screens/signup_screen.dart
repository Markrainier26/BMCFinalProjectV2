  ...
  Future<void> _signUp() async {
    ...
    try {
      ...
      try {
        ...
        // If Firestore save fails, delete the created user to avoid orphaned auth accounts
        await userCredential.user!.delete();
        throw Exception('Failed to save user data: $firestoreError');
      }

      // 3. AuthWrapper will auto-navigate to HomeScreen.

    } on FirebaseAuthException catch (e) {
      // 4. Handle specific sign-up errors
      ...
      // 5. Handle other errors, including Firestore errors
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
